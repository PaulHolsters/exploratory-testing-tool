<x-layout-1>
    <div class="mt-6 flex items-center justify-end gap-x-6">
        <button type="submit"
                class="rounded-md border-2 border-indigo-600 px-3 py-2 text-sm font-semibold shadow-sm focus-visible:outline
                focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
            Start recording
        </button>
        <button type="submit"
                class="border-2 border-indigo-600 rounded-md px-3 py-2 text-sm font-semibold shadow-sm focus-visible:outline
                focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
            Create bugreport
        </button>
    </div>
        ...
        <ul role="list" class="divide-y divide-gray-100 h-full">
            @foreach($test->bugreports as $bug)
                <li class="gap-x-6 py-5 bg-gray-200">
                    <a href="/bugreport/{{$bug['id']}}" class="flex justify-between">
